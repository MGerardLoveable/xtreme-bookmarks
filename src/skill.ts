...
3. Run \`xb search <query>\` for each
...
\`\`\`bash
xb search <query>              # Full-text BM25 search ("exact phrase", AND, OR, NOT)
xb list --category <cat>       # tool, technique, research, opinion, launch, security, commerce
xb list --domain <dom>         # ai, web-dev, startups, finance, design, devops, marketing, etc.
xb list --author @handle       # By author
xb list --after/--before DATE  # Date range (YYYY-MM-DD)
xb stats                       # Collection overview
xb viz                         # Terminal dashboard
xb show <id>                   # Full detail for one bookmark
\`\`\`

Combine filters: \`xb list --category tool --domain ai --limit 10\`
